...
},{"@fancyapps/ui":1}],96:[function(require,module,exports){
"use strict";
...
function init() {
  ...
  (0, _jquery.default)(document).ready(function () {
    (0, _jquery.default)(document).on("submit", "#callback-form", function (event) {
      event.preventDefault();
      var __this = (0, _jquery.default)(this);
      ...
      _jquery.default.ajax({
        ...
        success: function (data) {
          if (data.result == true) {
            ...
            __this.append((0, _jquery.default)("<div>", {
...
},{"hystmodal":3,"jquery":4}],97:[function(require,module,exports){
"use strict";
...
var _sliderPhoto = _interopRequireDefault(require("./modules/slider-photo"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
document.addEventListener('DOMContentLoaded', function (e) {
  _modal.default.init();
  _phoneMask.default.init();
  _fancybox.default.init();
  _sliderPhoto.default.init();
});

},{"../libs/modules/fancybox":95,"../libs/modules/modal":96,"../libs/modules/phone-mask":97,"./modules/slider-photo":98}]},{},[99]);
